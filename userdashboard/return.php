                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">Return Or Exchange</h4>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-3 mb-3">
                                                            <label class="form-label" for="orderID">Enter Your Order
                                                                ID</label>
                                                            <input id="orderID" name="productname" type="text" placeholder="#1575" class="form-control">
                                                        </div>
                                                        <div class="col-md-3 mb-3">
                                                            <label class="form-label" for="email">Enter Your Email</label>
                                                            <input id="email" name="email" type="text" class="form-control" placeholder="jhonesmith@gmail.com">
                                                        </div>
                                                        <div class="col-md-3 mb-3">
                                                            <label class="form-label" for="email">Enter Phone number</label>
                                                            <input id="email" name="email" type="text" class="form-control" placeholder="+1 589 835 7898">
                                                        </div>
                                                        ...
                                                        <table
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <a href="./return-details.php" >
                                                                            <span class="fw-bold">#1575</span>
                                                                        </a>
                                                                    </td>
                                                                    <td> April 1, 2024 at 1:15 pm </td>
                                                                    <td>Devid - Devid@gmail.com </td>
                                                                    <td> $78.5 </td>
                                                                    <td> -- </td>
                                                                    <td><span class="card-body-header"> <button class="btn warning-btn">Submitted</button></span></td>
                                                                    <td> May 1, 2024 at 1:15 pm </td>
                                                                    <td class="d-flex">
                                                                        <a href="./return-details.php"
                                                                            class="btn btn-yellow"><i class="fa-solid fa-arrow-right-long"></i>1</a>
                                                                            <a href="./return-details.php"
                                                                            class="btn "><i class="fa-solid fa-exchange"></i>1</a>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>
