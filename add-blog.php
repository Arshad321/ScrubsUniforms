                ...
                <div class="container-fluid">
                    ...
                    <div class="row prod_upload_card">
                                ...
                                <div class="d-flex flex-column">
                                    <div class="gift-recipt-wrp p-3 d-flex justify-content-between">
                                        <div class="expiry d-flex flex-column">
                                            <span class='text-dark fw-bold fs-5'>Excert</span>
                                        </div>
                                        <div class="reciept d-flex flex-column">
                                            <span class='text-dark fw-bold fs-5'> <a
                                                    href="javascript: void(0);">Excert</a></span>
                                        </div>

                                    </div>
                                    <p class="p-3">Add a summary of the post to appear on your home page or blog.
                                    </p>
                                </div>
                            </div>
                            <div class="card card-c">
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="card">
                                <div class="expiry d-flex flex-column mb-2">
                                    <span class='text-dark fw-bold fs-5 m-0'>Featured Image</span>
                                </div>
                                <div class="note-head"
                                    style="height: 300px;text-align: center;justify-content: center;border: dashed #cecece;background: #f7f7f7;">
