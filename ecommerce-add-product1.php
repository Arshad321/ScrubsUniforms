                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-8">
                                                                ...
                                                                <div class="card">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-3 mb-3">
                                                                            ...
                                                                            <input id="price" name="price" type="text" class="form-control" placeholder="$ 0.00">
                                                                        </div>
                                                                        <div class="col-md-3 mb-3">
                                                                            <label class="form-label" for="price">Compare-at Price</label>
                                                                            <input id="price" name="price" type="text" class="form-control" placeholder="$ 0.00">
                                                                        </div>
                                                                        <div class="col-md-12">
                                                                        ...
                                                                        <div class="col-md-3 mb-3">
                                                                            ...
                                                                            <input id="s_date" name="price" type="date" class="form-control" >
                                                                        </div>
                                                                        <div class="col-md-3 mb-3">
                                                                            <label class="form-label" for="">Start Time</label>
                                                                            <input id="s_time" name="price" type="time" class="form-control">
                                                                        </div>
                                                                        <div class="col-md-3 mb-3">
                                                                            <label class="form-label" for="">End Date</label>
                                                                            <input id="e_date" name="price" type="date" class="form-control" >
                                                                        </div>
                                                                        <div class="col-md-3 mb-3">
                                                                            <label class="form-label" for="">End Time</label>
                                                                            <input id="e_time" name="price" type="time" class="form-control" >
                                                                        </div>
                                                                        <div class="col-md-3 mb-3">
                                                                        ...
                                                                        <div class="col-md-3 mb-3">
                                                                            ...
                                                                            <input name="price" type="text" placeholder="20% / $20" class="form-control" >
                                                                        </div>

                                                                        <div class="col-md-12">
                                                                            <div class="taxCal mb-3">
                                                                                <input type="checkbox" checked> <p>Charge tax on this product</p>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-3 mb-3">
                                                                            <label class="form-label" for="price">Cost per item</label>
                                                                            <input id="price" name="price" type="text" class="form-control" placeholder="$ 0.00">
                                                                        </div>
                                                                        <div class="col-md-3 mb-3">
                                                                            <label class="form-label" for="price">Profit</label>
                                                                            <input id="price" name="price" type="text" class="form-control" placeholder="$ 0.00" disabled>
                                                                        </div>
                                                                        <div class="col-md-3 mb-3">
                                                                            <label class="form-label" for="price">Margin</label>
                                                                            <input id="price" name="price" type="text" class="form-control" placeholder="$ 0.00" disabled>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="card">
                                                                    ...
                                                                    <div class="taxCal mb-3">
                                                                        <input type="checkbox" checked> <p>Track quantity</p>
                                                                    </div>
                                                                    <div class="mb-3">
                                                                    ...
                                                                    <div class="mb-3">
                                                                        <div class="taxCal mb-3">
                                                                            <input type="checkbox" checked> <p>Continue selling when out of stock</p>
                                                                        </div>
                                                                        <div class="taxCal mb-3">
                                                                            <input type="checkbox" checked> <p>This product has a SKU or barcode</p>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="card">
                                                                    ...
                                                                    <div class="row align-items-center">
                                                                        ...
                                                                        <div class="row mb-3">
                                                                            <div class="col-md-5">
                                                                                <label for="">Default package (Used for single-item orders containing this product)</label>
                                                                                <select name="" id="" class="form-control">
                                                                                    <option value="">Add Packges</option>
                                                                                    <option value="">Custom</option>
                                                                                    <option value="">Scrubs Uniforms</option>
                                                                                </select>
                                                                            </div>
                                                                ...
                                                                <div class="card mb-2">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-2"> <a href="javascript:;" class="btns_blue">Add</a></div>
                                                                    </div>
                                                                    <br><br><br>
                                                                    <h4 class="card-title mb-2">Next Availablity Variant Date</h4>
                                                                    <div class="row">
                                                                        <div class="col-md-3">
                                                                            <label for="">Sizes</label>
                                                                                <select name="" id="" class="form-control" >
                                                                ...
                                                                <div class="card mb-2">
                                                                    ...
                                                                    <div class="variation_options">
                                                                        <div>
                                                                            ...
                                                                            <input type="text" placeholder="Value" id="item-size">
                                                                            <span id="add-size">Add Item</span>
                                                                            <ul id="size-list"> </ul>
                                                                        </div>
                                                                        <div>
                                                                            <label for="">Colors</label>
                                                                            <input type="text" placeholder="Value" id="item-color">
                                                                            <span id="add-color">Add Item</span>
                                                                            <ul id="color-list"> </ul>
                                                                        </div>
                                                                        <div>
                                                                            <label for="">Style</label>
                                                                            <input type="text" placeholder="Value" id="item-style">
                                                                        ...
                                                                        <table class="table table-centered product_table datatable dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    ...
                                                                                    <td><input type="text" class="p_price" value="43.99"></td>
                                                                                    <td><input type="text" class="p_qyt" value="200"></td>
                                                                                    <td><input type="text" class="p_on_hand" value="0"></td>
                                                                                    <td><span class="p_sku">4399</span></td>
                                                                                    <td><span class="p_vender">Dickies</span></td>
                                                                                    <td>
                                                            ...
                                                            <div class="col-md-4">
                                                                ...
                                                                <div class="card">
                                                                    ...
                                                                    <div class="mb-3">
                                                                        <label class="form-label" for="manufacturername">Vendor</label>
                                                                        <input id="manufacturername" name="manufacturername" type="text" class="form-control">
                                                                    </div>
                                                                    <div class="mb-3">
                                                                        <label class="form-label" for="manufacturername">Product Type</label>
                                                                        <input id="manufacturername" name="manufacturername" type="text" placeholder="e.g Top, Bottm" class="form-control">
                                                                    </div>
                                                                    <div class="mb-3">
                                                                    ...
                                                                    <div class="mb-3">
                                                                        <label class="form-label" class="control-label">Collection</label>
                                                                    ...
                                                                    <div class="mb-3">
                                                                        <label class="form-label" class="control-label">Tags</label>
