                                ...
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item">
                                            <a href="javascript: void(0);">Manage Blogs</a>
                                        </li>
                                        <li class="breadcrumb-item">
                                            <a href="javascript: void(0);">Manage Comments</a>
                                        </li>
                                        <li class="breadcrumb-item">
                                            <a href="add-blog.php">Add blog post</a>
                                        </li>
                                    </ol>
                                </div>
                            </div>
                                                                    ...
                                                                    <td>
                                                                        <div class='d-flex align-items-center'
                                                                            ...
                                                                            <div class="d-flex flex-column">
                                                                                <a href="javascript: void(0);"
                                                                                    class="text-dark fw-bold">How to find the perfect pair of Cargo Shirts</a>
                                                                               <p style="color: #636e75"class="mb-0">Junaid Zafar --- <a href="javascript: void(0);">News</a></p>
                                                                               <p style="color: #636e75"class="mb-0">Last edited 11 Jan at 1:09 pm</p>
                                                                            </div>
                                                                        </div>
                                                                    </td>
